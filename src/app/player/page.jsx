            ...
            <table className={"table"}>
                ...
                {currentGroup.map((group, index) => (
                    <tr key={group.id} className={index % 2 === 0 ? "evenRow" : "oddRow"}>
                        ...
                        <td>
                            <a href={`./player/edit/${group.id}`} className={"actionLink"}>EDIT</a>
                        </td>
                        <td>
                            <a href={`./player/edit/${group.id}`} className={"actionLink"}>DELETE</a>
                        </td>
                        <td>
                            <a href={`./player/edit/${group.id}`} className={"actionLink"}>SHOW</a>
                        </td>
                    </tr>
                ))}
                </tbody>
